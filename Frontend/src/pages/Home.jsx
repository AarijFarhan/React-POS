              ...
              {[ 
                ...
                <Card key={index} className='w-full sm:w-80 justify-center mx-auto '>
                  <CardHeader className='bg-white'>
                    <CardTitle>
                      <h2 className='text-green-800 text-lg md:text-xl'>{dish.name}</h2>
                    </CardTitle>
    ...
    {/* Testimonial Section */}
        ...
        <div className='md:flex sm:block my-0 mx-10 items-center '>
          <div className='sm:w-full p-6'>
            ...
            <button className='bg-green-500 text-white px-6 py-3 rounded-3xl mt-3'>Explore</button>
      ...
      <div className='md:flex sm:block my-0 mx-10 items-center '>
          <div className='sm:w-full p-6'>
            <h3 className='text-red-500 font-bold mt-6 '>Our Story & Services</h3>
            <h1 className='text-3xl sm:text-md font-bold mt-5 '>Our Culinary Journey And Services</h1>
            <p className='mt-3 text-xl w-[30rem] sm:text-sm'>Rooted in passion, we curate unforgettable dining experiences and offer exceptional services, blending culinary artistry with warm hospitality.</p>
